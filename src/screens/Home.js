...
const styles = StyleSheet.create({
  ...
  welcome: { fontSize: 26, fontWeight: 'bold', color: '#111', marginBottom: 20 },
  servicesRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 },
  serviceItem: { alignItems: 'center', flex: 1 },
  serviceText: { marginTop: 5, fontSize: 14, color: '#111', fontWeight: '500' },
  searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'white', borderRadius: 25, paddingHorizontal: 15, marginBottom: 20, borderWidth: 1, borderColor: '#ddd' },
  searchInput: { flex: 1, paddingVertical: 10 },
  optionCard: { backgroundColor: '#fff', borderRadius: 12, padding: 10, elevation: 3 },
  ...
  optionText: { fontSize: 16, color: '#1E40AF', fontWeight: '500' },
});
